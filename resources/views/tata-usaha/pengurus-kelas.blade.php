    ...
    <div class="mt-4 ml-4 pt-3 container-md bg-white">
        <form action="" method="get" class="flex gap-3 flex-col w-auto mb-3" id="form">
            <div class=" flex w-full justify-content-between">
                ...
                <a href="tambah-pengurus-kelas" class="btn btn-primary">Tambah Akun Pengurus Kelas</a>
            </div>
            <div class="flex gap-3">
                <select class="form-select filter" name="filter_jabatan" value="">
                    ...
                    <option value="ketua_kelas"
                        {{ old('filter_jabatan', request('filter_jabatan')) == 'ketua_kelas' ? 'selected' : '' }}>Ketua
                        Kelas
                    </option>
                    <option value="wakil_kelas"
                        {{ old('filter_jabatan', request('filter_jabatan')) == 'wakil_kelas' ? 'selected' : '' }}>Wakil
                        Kelas
                    </option>
                    <option value="sekertaris"
                        {{ old('filter_jabatan', request('filter_jabatan')) == 'sekertaris' ? 'selected' : '' }}>Sekertaris
                    </option>
                </select>
